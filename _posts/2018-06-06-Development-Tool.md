...
<h4>정적인 웹과 동적인 웹</h4>
<ul>
  <li><strong>정적인 웹</strong></li>
  서버에 미리 저장된 파일이 그대로 전달됩니다.<br><br>
  사용자는 서버에 저장된 데이터가 변경되지 않는 한, 고정된 페이지를 보게 됩니다. <br><br>
  <strong>client(user) <-> web server </strong><br><br>
  <li><strong>동적인 웹 </strong></li>
  ...
  <strong>client(user) <-> web server <-> application server</strong> <br>
</ul><br></p>
...
<ul>
  ...
  즉, 주고 받는 것이 가능합니다! <br>
  연결 유지와 통신 대기가 가능합니다. <br><br>
  <li> <strong> HTTP </strong></li>
  <strong>일회성 통신</strong><br>
  보내거나, 받거나, 일회성으로 통신하게 됩니다. <br>
  GET, POST 등의 명령을 하면 <strong>Request->, <-response 후 연결이 끊겨</strong> 버리기 때문에 <strong>소통이 불가능</strong>합니다.
</ul><br><br>
</p>
...
<ol>
  <li><strong>업무와 일상 분할이 가능합니다.</strong></li>
  퇴근 후 또는 여가 생활 중 카톡으로 일적인 사진이나 문서를 받을 때의, 그 말로 형용할 수 없는 기분에서 조금이나마 벗어날 수 있게 해주는 것 같네요 :> <br><br>
  <li><strong>다양한 생산성 앱을 지원합니다.</strong></li>
  Github과 연동이 가능하고, 그 이외에도 다양한 앱과도 연동해서 사용할 수 있습니다. <br><br>
  <li><strong>무료로도 꽤 많은 히스토리 보존이 가능합니다. </strong></li>
  학생이라면 무료를 찾기 마련인데, 무료임에도 많은 이전 대화와 자료들을 확인할 수 있습니다! <br><br>
  <li><strong>워크스페이스(단체)내의채널(공지사항, 일정) 기능</strong></li>
  단체를 분류하고 채널 내에서 게시물의 성격에 따라 분류할 수 있습니다. <br><br>
  <li><strong>웹, 모바일앱, 데스크탑앱 등의 다양한 플랫폼을 지원합니다.</strong> </li><br> 
</ol>
</p>
...
<ol>
  <li><strong>HTTP 통신 테스트 가능합니다. </strong></li>
  HTTP는 단방향 통신이기 때문에 postman을 사용하면 매우 편리해질 수 있습니다.<br><br>
  <li><strong>HTTP Request와 Response를 저장해둘 수 있습니다.</strong> </li>
  결과를 저장해두면 앱 개발자들이 <strong>서버의 기능을 확인</strong>할 수 있습니다! <br>
  서버의 기능을 명시할 수 있기 때문에 가능한 부분입니다.<br><br>
  <li><strong>컬렉션(워크스페이스), 폴더(채널) 기능이 있습니다. </strong></li><br>
  <li> 컬렉션 공유가 가능합니다. </li> <br>
  <li><strong>mockup 서버 구축이 가능합니다.</strong> </li>
  mockup 서버란 간단한 작업을 위해 가상의 서버에서 작업하는 것을 말합니다. <br><br>
  <li><strong>문서 생성기능이 있습니다. </strong> </li>
  가독성이 굉장히 높고 레이아웃이 깔끔하답니당<br><br>
  <li>서버 테스트 기능이 있습니다. </li>
</ol><br>
</p>
...
<ol>
  <li><strong>버전 관리가 가능합니다.</strong></li>
  이로써 <u>버그를 대처할 수 있다</u>는 장점을 얻게 되겠죠 :) <br>
  새로운 버전에서 치명적인 버그가 발생되면 우리는 Github으로 복원할 수 있습니다.<br><br>
  <li><strong>협업이 편리합니다. </strong></li>
  <code>Branch</code>를 이용하면 각자 맡은 부분은 개발하고 합칠 수 있는 <code>merge</code>라는 기능이 존재합니다.
  하지만 같은 파일은 수정했을 경우에는 <code>conflict</code>가 발생할 수 있으므로 유의해야 합니다. <br><br>
  <li><strong>Issues(버그, 기능, 문의)관리를 할 수 있습니다. </strong></li>
  ...
  <li>Milestone로 Issues를 결합하여 마감일을 정하는 등의 활용이 가능합니다. </li><br>
  <li>터미널에서 commit과 함께 issue 완료 처리를 하려면 다음과 같은 명령어를 입력하면 됩니다. </li>
</ol>
</p>
...
<ul> 
  <li> init </li>
  git repository를 생성합니다. <br><br>
  <li> local / remote </li>
  사용자의 컴퓨터 / git 서버  <br><br>
  <li> commit  </li>
  변경된 내용을 comment와 함께 snapshot을 남깁니다. <br><br>
  <li><strong>push</strong></li>
  local의 commits을 remote에 반영합니다.  <br><br>
  <li><strong>pull</strong></li>
  remote의 commits을 local에 반영합니다.<br><br>
  <li>fetch</li>  
  remote의 commits을 local로 그대로 가져옵니다. <br><br>
  <li>branch </li>
  서로 다른 원본을 가지는 commit들로 나눠집니다. <br><br>
  <li>clone </li>
  local에 repository 복제합니다.  <br><br>
  <li>merge   </li>
  branch 혹은 commit 간의 내용이 다른 부분을 합칩니다. (하나의 commit)  <br><br>
  <li>fork </li>
  github에 다른 사람의 repository를 복사합니다.<br> 
  해당 repository가 업데이트 되면 바로 반영할 수 있습니다.<br><br>
  <li>stash  </li>
  commit으로 만들지 않은 변경 내용을 임시로 저장하는 기능으로, merge를 원하지 않을 때 사용합니다. <br>
  이 명령어를 이용하면 충돌을 피할 수 있습니다.<br><br>
  <li><strong>revert</strong></li> 
  삭제하고 싶은 commit의 이전 commit을 불러올 수 있습니다. 
</ul></p>
...
<ul>
  ...
  이 경우에는 아래와 같이 충돌이 나게 되면 수동으로 merge 작업을 해줘야합니다.<br>
</ul></p>
...
<ul>
  <ul>
  <li>diff  </li>
  local의 commit과 다른 파일들을 다 보여줍니다.  <br>
  <li>status </li>
  수정된 파일들을 보여줍니다.  <br>
  <li>rebase  </li>
  merge랑 비슷한 개념으로, commit을 병합하고 commit message를 수정할 수 있습니다.<br>
  </ul>
</ul>
</p>
...
<ol>
  <li>여러 프로젝트의 Issues를 한번에 볼 수 있습니다. </li>
  github에서는 각각 repository별로만 관리 가능해서 같은 어플리케이션이라도 iOS, Android, Server의 Issues를 한번에 관리할 수 없는데, Waffle을 사용하면 가능하게 됩니다.<br><br>
  <li>팀 프로젝트에서 ios, android, server 의 Issues를 한번에 관리할 수 있기 때문에 편리합니다.</li>
</ol></p>
