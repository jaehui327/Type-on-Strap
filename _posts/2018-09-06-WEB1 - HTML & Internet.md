...
앞으로도 살아남을 가능성이 매우 높습니다. <br><br>
</p>
<p>
코딩을 하기 위해서는 에디터(Editor)라는 프로그램이 필요합니다.<br>
search <code>html editor</code> <br>
이 수업에서는 <a href="https://atom.io/" target="_blank" title="Atom">Atom</a> 이라는 에디터를 채택했습니다. <br><br>
</p>
<p>
<h3>태그</h3>  
<ol>
<h4><li><strong>강조하기</strong></li></h4>
중요한 내용을, 강조표시로 <strong>글씨를 진하게 표시</strong>하고 싶어졌습니다.
...
<h4><li><u>밑줄(언더라인)</u></li></h4>
보다 더 중요한 부분에는 밑줄을 치고 싶어졌어요. <br>
underline의 첫글자인 u 태그를 사용해봅시다. <br>
...
<p>
<h3>태그 추측해보기</h3><br>
<code> <h1>W3C</h1> </code> <br>
search <code>HTML h1 tag</code> <br>
<a href="https://www.w3schools.com/tags/tag_hn.asp" target="_blank" title="HTML h1 tag">검색결과</a> heading 은 <code>제목</code> 이네요! <br><br>
검색을 통해 빠르게 정보를 알아낼 수 있다면 <br>
이미 알고 있는 정보나 다름없습니다. <br>
검색을 두려워 하지 마세요. <br><br>
</p>
<p>
<h3>통계에 기반한 학습  </h3>
...
중국어 공부를 하려고 할 때, <strong>그 많은 한자를 다 외워야 할까요?</strong>  
...
공부를 할 때, 통계를 기반으로 공부방향을 스스로 설정해보는건 어떨까요?<br><br>
</p>  
<p>
<h3>줄바꿈 태그 </h3>
<ol>
...
CSS를 이용하면 p태그의 한계를 극복할 수 있습니다.<br>
<code><p style="margin-top:45px;"></code>
</ol>
</p> 
<p>
<h3>부모자식과 목록  </h3>
<code><ul></code> (unordered list)  <br>
다른 목록과 구분할 수 있도록 경계가 필요할 때 사용합니다.  <br>
<code>
<ul>
  <li>1. HTML</li>
  <li>2. CSS</li>
...
제목을 나타내주는 <title> 태그와 <br>
한글이 깨지지 않도록 웹페이지를 UTF-8 방식으로 열도록 하는 <meta charset> 태그입니다. <br><br>
...
또 이 웹페이지가 HTML로서 만들어졌다는 것을 표현하기 위해서  문서의 시작에 <!doctype html>를 추가합니다. <br>
<code>
<!doctype html>
<html>
<head>
...
공부를 하면 이렇게 눈이 밝아지고 시력이 좋아집니다. 예전에는 보이지 않았던 것이 보입니다.  <br>
</p>
<h3>링크  </h3>
<code>
...
<h3>원시웹  </h3>
<a href="http://info.cern.ch" target="_blank" title="세계 최초의 웹페이지">세계 최초의 웹페이지</a>입니다. <br>
</p>